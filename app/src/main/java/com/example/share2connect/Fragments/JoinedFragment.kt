 ...
 * Use the [JoinedFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class JoinedFragment(var userId:Int) : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view=inflater.inflate(R.layout.fragment_joined, container, false)
